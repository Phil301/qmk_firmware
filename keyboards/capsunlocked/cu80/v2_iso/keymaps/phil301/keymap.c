...
qk_tap_dance_action_t tap_dance_actions[] = {
  ...
  [TD_CTRL_ENTER] = ACTION_TAP_DANCE_DOUBLE(KC_F12, LCTL(KC_ENT)),
};
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_FN] = LAYOUT_tkl_iso(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, TD(TD_CTRL_ENTER),
