...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_CTRL] = LAYOUT_tkl_iso(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, LCTL(KC_BSPC), _______,      LCTL(KC_HOME), LCTL(KC_PGUP),
