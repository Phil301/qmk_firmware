...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [L_CTRL] = LAYOUT_tkl_iso(
    ...
    _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,    LCTL(KC_0), LCTL(KC_MINS), LCTL(KC_EQL), LCTL(KC_BSPC), _______, LCTL(KC_HOME), LCTL(KC_PGUP),
    _______, _______, _______, _______, _______, _______, _______, _______, _______, LCTL(KC_O), LCTL(KC_P), LCTL(KC_LBRC), LCTL(KC_RBRC),          LCTL(KC_DEL), LCTL(KC_END),  LCTL(KC_PGDN),
